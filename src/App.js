...
class App extends Component {
    ...
    setpointLocation = (point) => {
        ...
        },() => console.log(this.state.pointLocation))
    }
            ...
            <Fragment>
                ...
                <Container maxWidth={"xl"} style={{marginTop: '5vh'}}>
                    <Grid container justify={'center'} spacing={3}>
                        <Search setpointLocation={this.setpointLocation} setAllMarkers={this.setAllMarkers}/>
                        <Map center={this.state.pointLocation} markers={this.state.allMarkers}/>
                    </Grid>
                </Container>
            </Fragment>
        );
